...
export default class SettingsPanel extends Component {
  ...
  render() {
    const {timerDurationChange, work, rest, goalChange, goals, settingAutoBreakToggle, settingAlarmAudioToggle, settings} = this.props
    return (
  ...
  componentWillMount() {
    // this check if the browser is a mobile browser using regex
