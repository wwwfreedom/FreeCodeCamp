...
const initialState = {
  ...
  portfolio: [
    ...
    },
    {
      ...
      description: "I build this application as a zipline project for Free Code Camp. The focus of this app in on simplicity and displaying useful metric to keep the user motivated."
    }
  ]
}
